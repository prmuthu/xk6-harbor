module github.com/prmuthu/xk6-harbor
...
require (
	...
	github.com/docker/distribution v0.0.0-20191216044856-a8371794149d // indirect
...
replace github.com/docker/docker => github.com/docker/docker v20.10.9+incompatible
